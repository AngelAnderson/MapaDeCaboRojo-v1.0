    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-slate-900 flex items-center justify-center p-6 text-center">
          <div className="bg-slate-800 p-8 rounded-3xl border border-line shadow-2xl max-w-md w-full">
            ...
            <p className="text-ink-muted mb-6">La aplicación tuvo un error inesperado.</p>
