...
export default async function handler(req: any, res: any) {
  try {
    ...
    if (isPRSF) {
      ...
      const paths = ['', '/prediccion', '/costo-de-vida', '/rendimiento', '/cupon', '/demanda-real', '/trabajo', '/decidir', '/exposicion-ai', '/sigue-el-dinero', '/recuperacion', '/agua', '/luz', '/basura', '/diabetes', '/telemedicina', '/historial', '/no-se-mide', '/esencia', '/registro/estado', '/comparte', '/sinfiltros/pulso', '/expediente/alcalde-cabo-rojo', '/expediente/representante-distrito-20'];
