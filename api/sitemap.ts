...
export default async function handler(req: any, res: any) {
  try {
    ...
    if (isPRSF) {
      ...
      const paths = ['/', '/ultima-cifra', '/numero-mas-nuevo', '/prediccion', '/predicciones', '/mision', '/calculadora', '/costo-de-vida', '/rendimiento', '/cupon', '/trabajo', '/decidir', '/exposicion-ai', '/sigue-el-dinero', '/recuperacion', '/agua', '/activos', '/luz', '/basura', '/historial', '/no-se-mide', '/esencia', '/sinfiltros/pulso', '/expediente-power-expectations', '/expediente/alcalde-cabo-rojo', '/expediente/representante-distrito-20', '/salud-que-falta', '/contradicciones', '/acueductos', '/funciona', '/transicion', '/retiro', '/semaforo-fema', '/los-78', '/notas', '/salud-mental'];
