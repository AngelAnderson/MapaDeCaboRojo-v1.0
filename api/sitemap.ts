...
export default async function handler(req: any, res: any) {
  try {
    ...
    if (isPRSF) {
      ...
      const paths = ['', '/ultima-cifra', '/prediccion', '/costo-de-vida', '/rendimiento', '/cupon', '/trabajo', '/decidir', '/exposicion-ai', '/sigue-el-dinero', '/recuperacion', '/agua', '/activos', '/luz', '/basura', '/diabetes', '/telemedicina', '/historial', '/no-se-mide', '/esencia', '/registro/estado', '/comparte', '/sinfiltros/pulso', '/expediente/alcalde-cabo-rojo', '/expediente/representante-distrito-20'];
