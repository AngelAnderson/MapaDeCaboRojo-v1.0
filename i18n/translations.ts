...
export const translations = {
  es: {
    ...
    ask_ai: "Preguntarle a Cabo",
    suggest_edit: "Sugerir actualización",
    concierge_title: "El Veci 'Cabo'",
    concierge_subtitle: "Sabe de todo (o se lo inventa)",
  ...
  en: {
    ...
    concierge_title: "Cabo The Concierge",
    concierge_subtitle: "Knows everything (or invents it)",
